...
'************************************************************************
'Quick (Q) Navigator v1.0 "Copyright 2001" :-) By U.Sudeep Nayak
'
'
'Find more support on this project:
'writetosudeep@yahoo.com
'sudeep@sjbhs2000.com
'
'
'Terms of Agreement:
...
'     web site) without written permission from the original author(U.Sudeep Nayak).
